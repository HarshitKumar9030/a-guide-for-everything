            ...
            <AnimatePresence>
                {showDuplicateMessage && (
                    <motion.div
                        ...
                        className="fixed bottom-20 left-1/2 transform -translate-x-1/2 z-50 max-w-md w-full mx-4"
                    >
                        <div className="bg-red-600/95 backdrop-blur-md border border-red-500/30 rounded-xl p-4 shadow-2xl">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <Save className="w-4 h-4 text-red-200" />
                                </div>
                                <div className="flex-1">
                                    <h3 className="text-white font-medium text-sm mb-1">Already Saved</h3>
                                    <p className="text-red-100 text-xs">
                                        You have already saved this guide. Check your saved guides in your profile.
                                    </p>
                                </div>
                                <motion.button
                                    ...
                                    className="w-6 h-6 bg-red-500/20 hover:bg-red-500/30 rounded-lg flex items-center justify-center text-red-200 hover:text-white transition-colors"
                                >
                                    ×
                                </motion.button>
                            </div>
